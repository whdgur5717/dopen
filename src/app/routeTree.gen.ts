...
const AuthPostIndexLazyImport = createFileRoute('/_auth/post/')();
...
const AuthPostIndexLazyRoute = AuthPostIndexLazyImport.update({
  path: '/post/',
  getParentRoute: () => AuthRoute,
} as any).lazy(() =>
  import('./routes/_auth/post/index.lazy').then((d) => d.Route),
);
...
const AuthBoardIndexLazyRoute = AuthBoardIndexLazyImport.update({
  path: '/',
...
const AuthBoardBoardlayoutBoardNamePostIdRoute =
  AuthBoardBoardlayoutBoardNamePostIdImport.update({
    ...
    import('./routes/_auth/Board/_boardlayout/$boardName/$postId.lazy').then(
      (d) => d.Route,
    ),
  );
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_auth/Board/': {
      ...
      path: '/';
      fullPath: '/Board/';
      preLoaderRoute: typeof AuthBoardIndexLazyImport;
    ...
    '/_auth/post/': {
      ...
      path: '/post';
      fullPath: '/post';
      preLoaderRoute: typeof AuthPostIndexLazyImport;
      parentRoute: typeof AuthImport;
    };
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_auth/post/": {
      "filePath": "_auth/post/index.lazy.tsx",
      "parent": "/_auth"
    },
    "/_auth/Board/_boardlayout/$boardName/$postId": {
